...
在使用 fourier aurora client 之前，请确保 **Aurora** 已启动。要初始化 fourier aurora client，请使用 `get_instance` 函数。*domain_id* 和 *robot_name* 参数是与 Aurora 连接的必需参数。对于 GR-3，*domain_id* 默认设置为 123，*robot_name* 应为 "gr3"。*namespace* 和 *is_ros_compatible* 选项保留供将来使用。
