...
Aurora uses DDS as the message middleware, and the main data interaction adopts two modes: subscription/publish and request/response.

...

## Control Overview

Aurora does not support direct control on actuators, all joint controls in Aurora are aligned with the urdf model. For parallel mechanism, the calculation is done within Aurora, and only joint level state and command will be avaliable. To achive actuator level control, please refer to *fourier_actuator_sdk*.
...
--------------------|------------------|-------------|-------------
Default             | LB+RB            | 0           | [Default State Specification](state_specification/default_state_EN.md)
Security Protection | LT+RT            | 9           | [Security Protection State Specification](state_specification/security_protection_state_EN.md)
Joint Stand         | LB+A             | 1           | [Joint Stand State Specification](state_specification/joint_stand_state_EN.md)
PdStand             | LB+A             | 2           | [PdStand State Specification](state_specification/pd_stand_state_EN.md)
CPG Walk            | RB+A             | 3           | [CPG Walk State Specification](state_specification/cpg_walk_state_EN.md)
UserCmd             | No               | 10          | [UserCmd State Specification](state_specification/user_cmd_state_EN.md)
Upper UserCmd       | No               | 11          | [Upper UserCmd State Specification](state_specification/upper_user_cmd_state_EN.md)
